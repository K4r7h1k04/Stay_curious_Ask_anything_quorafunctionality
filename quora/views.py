"""
    The get_object_or_404 function is used to retrieve an object from a model based on certain criteria
    
    Standard Django exception that is raised when a requested resource is not found. It is used to handle 404 errors and display an appropriate error page to the user. 
"""
